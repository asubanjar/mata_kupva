...
class SubjectController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/watchlist/subject')->with('success', 'Sukses menambahkan subjek');
    }
    ...
    public function show(Subject $subject)
    {
        ...
        return view('watchlist/subject/view', compact(
            'subject',
            'subject_details',
            'subject_detail_done',
    ...
    public function destroy(Subject $subject)
    {
        ...
        return redirect('/watchlist/subject')->with('success', 'Sukses menghapus subjek');
    }
}