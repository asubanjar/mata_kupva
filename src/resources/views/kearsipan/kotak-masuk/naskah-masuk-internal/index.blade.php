     @extends('layouts.app')
     @section('title', 'Daftar Naskah Masuk Internal')
     @section('content')
                     ...
                     <div class="app-toolbar-wrapper d-flex flex-stack w-100 flex-wrap gap-4">
                         ...
                         <div class="page-title d-flex flex-column justify-content-center me-3 gap-1">
                             ...
                             <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                                 ...
                                 <!--end::Item-->
                                 <!--begin::Item-->
                                 <li class="breadcrumb-item text-muted">Naskah Masuk Internal</li>
                                 <!--end::Item-->
                             </ul>
                             <!--end::Breadcrumb-->
                         </div>
                                 ...
                                 <tbody class="fw-semibold text-gray-600">
                                     <tr>
                                         ...
                                         <td>
                                             ...
                                             <div class="badge badge-light-info fw-bold mb-2">Naskah Masuk Internal</div>
                                         </td>
                                         <td>
                                         ...
                                         <td>
                                             <div class="text-hover-primary mb-2 text-gray-800">Naskah Masuk Internal</div>
