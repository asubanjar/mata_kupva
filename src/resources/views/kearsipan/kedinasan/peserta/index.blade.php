                ...
                <div class="app-toolbar-wrapper d-flex flex-stack w-100 flex-wrap gap-4">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center me-3 gap-1">
                        ...
                        <h1 class="page-heading d-flex flex-column justify-content-center text-dark fw-bold fs-3 m-0">
                            Data Peserta - {{ $surat_tugas->perihal_nodis }}
                        </h1>
                        <!--end::Title-->
                        <!--begin::Breadcrumb-->
                                ...
                                @foreach ($pesertas as $peserta)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" class="menu-link delete-peserta" data-id="{{ $peserta->id }}"
                                                data-nama="{{ $peserta->nama_peserta }}" data-csrf="{{ csrf_token() }}"
                                                data-table-filter="delete_row">
            ...
            <div class="modal-content">
                ...
                <form id="add_form" method="post"
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="submitPeserta" type="submit" class="btn btn-primary">
...
@section('script')
    <script src="{{ asset('assets/js/pages/peserta/validate.js') }}"></script>
    ...
    <script type="text/javascript">
        ...
        $(document).on("click", ".delete-peserta", function(e) {
            e.preventDefault();
