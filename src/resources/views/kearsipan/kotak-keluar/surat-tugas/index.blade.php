                             ...
                             <table class="table-row-dashed fs-6 gy-5 table align-middle" id="kt_table_users">
                                 <thead>
                                     <tr class="text-muted fw-bold fs-7 text-uppercase gs-0 text-start">
                                         ...
                                         <th class="min-w-125px">Lokasi QR</th>
                                 ...
                                 <tbody class="fw-semibold text-gray-600">
                                     <tr>
                                         <td>
                                             <div></div>24 Okt 2023, 04:42
                                         </td>
                                         <td>
                                             <div class="text-hover-primary mb-1 text-gray-800">T/12/RT.01/XI/2023</div>
                                             <div class="badge badge-light-primary fw-bold mb-2">Surat Tugas</div>

                                         </td>
                                         <td>
                                             <div class="text-hover-primary mb-2 text-gray-800">Permohonan Surat Tugas a.n.
                                                 Danis
                                                 Prabandana Mengikuti Kegiatan Konsinyering
                                                 T.A. 2023
                                                 di Kota Depok</div>
                                         ...
                                         <td>
                                             <div class="text-hover-primary mb-2 text-gray-800">Lorem ipsum dolor sit amet
                                                 !</div>
                                             <div class="badge badge-light-success fw-bold mb-2">Sudah Dikirim</div>
                                             <div>
                                                 Token:
                                                 <div class="badge badge-light-info fw-bold mb-2">7SJJ3A52</div>
                                             </div>
                                     ...
                                     <tr>
                                         ...
                                         <td>
                                             <div class="text-hover-primary mb-1 text-gray-800">T/128/RT.01/X/2023</div>
                                             <div class="badge badge-light-primary fw-bold mb-2">Surat Tugas</div>
                                         ...
                                         <td>
                                             <div class="text-hover-primary mb-2 text-gray-800">Permohonan Surat Tugas a.n.
                                                 Danis
                                                 Prabandana Mengikuti Kegiatan Pelatihan Dasar Penanganan Bukti Elektronik
                                                 T.A. 2023
                                                 di Kota Depok</div>
