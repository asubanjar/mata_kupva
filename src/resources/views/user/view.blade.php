                            ...
                            <div class="card-body pb-0">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex align-items-center flex-grow-1">
                                        ...
                                        <!--begin::Info-->
                                        <div class="d-flex flex-column">
                                            <a href="#" class="text-hover-primary fs-6 fw-bold text-gray-900">Grace
                                                Green</a>
                                            <span class="fw-bold text-gray-400">PHP, SQLite, Artisan CLI</span>
                                        </div>
                                        <!--end::Info-->
                                    </div>
                                    <!--end::User-->
                            ...
                            <div class="card-body pb-0">
                                ...
                                <div class="d-flex align-items-center mb-5">
                                    ...
                                    <div class="d-flex align-items-center flex-grow-1">
                                        ...
                                        <!--begin::Info-->
                                        <div class="d-flex flex-column">
                                            <a href="#" class="text-hover-primary fs-6 fw-bold text-gray-900">Nick
                                                Logan</a>
                                            <span class="fw-bold text-gray-400">PHP, SQLite, Artisan CLI</span>
                                        </div>
                                        <!--end::Info-->
                                ...
                                <div class="mb-5">
                                    <!--begin::Text-->
                                    <p class="fw-normal mb-5 text-gray-800">Outlines keep you honest. They stop you from
                                    ...
                                    <div class="d-flex align-items-center mb-5">
                                        <a href="#"
                                            class="btn btn-sm btn-light btn-color-muted btn-active-light-success me-4 px-4 py-2">
                                ...
                                <form class="position-relative mb-6">
                                    <textarea class="form-control min-h-25px resize-none border-0 p-0 pe-10" data-kt-autosize="true" rows="1"
                                        placeholder="Reply.."></textarea>
                                    <div class="position-absolute me-n5 end-0 top-0">
                                        <span class="btn btn-icon btn-sm btn-active-color-primary me-2 pe-0">
                            ...
                            <div class="card-body pb-0">
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div class="d-flex align-items-center flex-grow-1">
                                        ...
                                        <!--begin::Info-->
                                        <div class="d-flex flex-column">
                                            <a href="#" class="text-hover-primary fs-6 fw-bold text-gray-900">Carles
                                                Nilson</a>
                                            <span class="fw-bold text-gray-400">Yestarday at 5:06 PM</span>
                                        </div>
                                        <!--end::Info-->
                                    </div>
                                    <!--end::User-->
                                ...
                                <div class="mb-7">
                                    ...
                                    <div class="d-flex mb-5">
                                        ...
                                        <div class="d-flex flex-column flex-row-fluid">
                                            ...
                                            <div class="d-flex align-items-center mb-1 flex-wrap">
                                                <a href="#"
                                                    class="text-hover-primary fw-bold me-2 text-gray-800">Alice Danchik</a>
                                                <span class="fw-semibold fs-7 text-gray-400">1 day</span>
                                                <a href="#"
                                                    class="text-hover-primary fw-semibold fs-7 ms-auto text-gray-400">Reply</a>
                                            </div>
                                            <!--end::Info-->
                                            <!--begin::Post-->
                                            <span class="fs-7 fw-normal pt-1 text-gray-800">Long before you sit dow to put
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="d-flex flex-column flex-row-fluid">
                                            ...
                                            <div class="d-flex align-items-center mb-1 flex-wrap">
                                                <a href="#"
                                                    class="text-hover-primary fw-bold me-2 text-gray-800">Harris Bold</a>
                                                <span class="fw-semibold fs-7 text-gray-400">2 days</span>
                                                <a href="#"
                                                    class="text-hover-primary fw-semibold fs-7 ms-auto text-gray-400">Reply</a>
                                            </div>
                                            <!--end::Info-->
                                            <!--begin::Post-->
                                            <span class="fs-7 fw-normal pt-1 text-gray-800">Outlines keep you honest. They
                                ...
                                <div class="d-flex align-items-center mb-5">
                                    ...
                                    <div class="d-flex align-items-center flex-grow-1">
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="#" class="text-hover-primary fs-6 fw-bold text-gray-900">Carles
                                                Nilson</a>
                                            <span class="fw-bold text-gray-400">Last week at 10:00 PM</span>
                                        </div>
                                        <!--end::Info-->
                                    </div>
                                    <!--end::User-->
                            ...
                            <div class="card-body pb-0">
                                ...
                                <div class="d-flex align-items-center mb-5">
                                    ...
                                    <div class="d-flex align-items-center flex-grow-1">
                                        ...
                                        <!--begin::Info-->
                                        <div class="d-flex flex-column">
                                            <a href="#" class="text-hover-primary fs-6 fw-bold text-gray-800">Carles
                                                Nilson</a>
                                            <span class="fw-bold text-gray-400">Last week at 10:00 PM</span>
                                        </div>
                                        <!--end::Info-->
                                ...
                                <div class="mb-7">
                                    <!--begin::Image-->
                                    <div class="bgi-no-repeat bgi-size-cover min-h-250px mb-5 rounded"
