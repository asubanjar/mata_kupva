                            ...
                            <div class="app-header-menu app-header-mobile-drawer align-items-stretch"
                                ...
                                <div class="menu menu-rounded menu-column menu-lg-row my-lg-0 align-items-stretch fw-semibold px-lg-0 my-5 px-2"
                                    ...
                                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                        ...
                                        <!--begin:Menu sub-->
                                        <div
                                            class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown w-100 w-lg-850px p-0">
                                            ...
                                            <div class="menu-state-bg menu-extended overflow-lg-visible overflow-hidden"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8 mb-lg-0 py-lg-6 px-lg-6 mb-3 px-3 py-3">
                                                        ...
                                                        <!--begin:Landing-->
                                                        <div
                                                            class="d-flex flex-stack flex-lg-nowrap mx-5 flex-wrap gap-2">
                                                    ...
                                                    <!--begin:Col-->
                                                    <div
                                                        class="menu-more bg-light col-lg-4 py-lg-6 px-lg-6 rounded-end px-3 py-3">
                                                        <!--begin:Heading-->
                                            ...
                                            <div class="menu-active-bg px-lg-0 px-4">
                                                ...
                                                <div class="d-flex w-100 overflow-auto">
                                                    <ul
                                                        ...
                                                        <!--begin:Nav item-->
                                                        <li class="nav-item mx-lg-1">
                                                            <a class="nav-link py-lg-6 text-active-primary py-3"
                                                                href="#" data-bs-toggle="tab"
                                        ...
                                        <div
                                            ...
                                            <div class="menu-active-bg py-lg-6 px-lg-6 px-3 pb-3 pt-1"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-4 mb-3">
                                                                <!--begin:Heading-->
                                                                <h4
                                                                    class="fs-6 fs-lg-4 fw-bold mb-3 ms-4 mt-3 text-gray-800">
                                                                    Layouts</h4>
                                                                <!--end:Heading-->
                                                                <!--begin:Menu item-->
                                                                <div class="menu-item m-0 p-0">
                                                        ...
                                                        <!--end:Row-->
                                                        <div class="separator separator-dashed mx-lg-5 mb-6 mt-2">
                                                        </div>
                                                    ...
                                                    <!--begin:Col-->
                                                    <div
                                                        class="col-lg-5 py-lg-3 pe-lg-8 d-flex align-items-center mb-3">
                                                ...
                                                <div class="scroll-y mh-325px my-5 px-8">
                                                    ...
                                                    <div class="d-flex flex-stack py-4">
                                                        ...
                                                        <div class="d-flex align-items-center me-2">
                                                            ...
                                                            <!--begin::Title-->
                                                            <a href="#"
                                                                class="text-hover-primary fw-semibold text-gray-800">Server
                                                                OS update</a>
                                                            <!--end::Title-->
                                                        </div>
                                                        <!--end::Section-->
                                        ...
                                        <div class="menu-item px-5"
                                            ...
                                            <a href="#" class="menu-link px-5">
                                                <span class="menu-title position-relative">Mode
                                                    <span
                                                        class="position-absolute translate-middle-y top-50 end-0 ms-5">
                            ...
                            <div
                                ...
                                <div class="text-dark order-md-1 order-2">
                                    ...
                                    <a href="https://keenthemes.com" target="_blank"
                                        class="text-hover-primary text-gray-800">Keenthemes</a>
                                </div>
                                <!--end::Copyright-->
                                <!--begin::Menu-->
                                ...
                                <div class="timeline-content mt-n1 mb-10">
                                    ...
                                    <div class="overflow-auto pb-5">
                                        ...
                                        <div
                                            ...
                                            <!--begin::Users-->
                                            <div
                                                class="symbol-group symbol-hover flex-grow-1 min-w-100px flex-nowrap">
                                                <!--begin::User-->
                                                <div class="symbol symbol-circle symbol-25px">
                                            ...
                                            <div class="fv-row mb-10">
                                                ...
                                                <label class="d-flex align-items-center fs-5 fw-semibold mb-2">
                                                    ...
                                                    <span class="ms-1" data-bs-toggle="tooltip"
                                                        ...
                                                        <i class="ki-duotone ki-information-5 fs-6 text-gray-500">
                                                            <span class="path1"></span>
                                                            <span class="path2"></span>
                                                            <span class="path3"></span>
                                                        </i>
                                        ...
                                        <div>
                                            <button type="button" class="btn btn-lg btn-primary"
                                                ...
                                                <span class="indicator-label">Submit
                                                    <i class="ki-duotone ki-arrow-right fs-3 me-0 ms-2">
                                                        <span class="path1"></span>
                                                        <span class="path2"></span>
                                                    </i></span>
                                                <span class="indicator-progress">Please wait...
                                            ...
                                            <button type="button" class="btn btn-lg btn-primary"
                                                ...
                                                <i class="ki-duotone ki-arrow-right fs-3 me-0 ms-1">
                                                    <span class="path1"></span>
                                                    <span class="path2"></span>
                                                </i></button>
                                        </div>
                    ...
                    <div class="modal-body scroll-y mx-xl-18 pb-15 mx-5 pt-0">
                        ...
                        <div class="mb-15">
                            ...
                            <div class="mh-375px scroll-y me-n7 pe-7">
                                <!--begin::User-->
                                <div
                                    class="d-flex flex-stack border-bottom border-bottom-dashed border-gray-300 py-5">
                                    <!--begin::Details-->
                                    <div class="d-flex align-items-center">
                                        <!--begin::Avatar-->
                                        <div class="symbol symbol-35px symbol-circle">
                    ...
                    <div class="modal-body scroll-y mx-xl-18 pb-15 mx-5 pt-0">
                        ...
                        <div id="kt_modal_users_search_handler" data-kt-search-keypress="true"
                            ...
                            <form data-kt-search-element="form" class="w-100 position-relative mb-5"
                                ...
                                <!--begin::Icon-->
                                <i
                                    class="ki-duotone ki-magnifier fs-2 fs-lg-1 position-absolute top-50 translate-middle-y ms-5 text-gray-500">
                                    <span class="path1"></span>
                                    <span class="path2"></span>
                                </i>
                                <!--end::Icon-->
