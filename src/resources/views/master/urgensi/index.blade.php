                            ...
                            <form class="form" action="#" id="kt_modal_add_customer_form"
                                ...
                                <div class="modal-body px-lg-17 py-10">
                                    ...
                                    <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll"
                                        ...
                                        <!--end::Billing toggle-->
                                        <!--begin::Billing form-->
                                        <div id="kt_modal_add_customer_billing_info" class="show collapse">
                                            <!--begin::Input group-->
                                    ...
                                    <div class="row fv-row mb-15">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <label
                                                ...
                                                <span class="form-check-label fw-semibold text-gray-600">All</span>
                                            </label>
                                            <!--end::Radio button-->
                                            <!--begin::Radio button-->
                                            <label
                                                ...
                                                <input class="form-check-input" type="checkbox" value="2"
                                                    checked="checked" name="payment_type" />
                                                <span class="form-check-label fw-semibold text-gray-600">Visa</span>
                                            </label>
                                            <!--end::Radio button-->
                                            <!--begin::Radio button-->
                                            <label
                                                ...
                                                <input class="form-check-input" type="checkbox" value="3"
                                                    name="payment_type" />
                                                <span class="form-check-label fw-semibold text-gray-600">Mastercard</span>
                                            </label>
                                            <!--end::Radio button-->
                                            <!--begin::Radio button-->
                                            <label class="form-check form-check-custom form-check-sm form-check-solid">
                                                <input class="form-check-input" type="checkbox" value="4"
                                                    name="payment_type" />
                                                <span class="form-check-label fw-semibold text-gray-600">American
                                                    Express</span>
                                            </label>
                                            <!--end::Radio button-->
                                        </div>
