@extends('layouts.app')
@section('title', 'Master Jenis Perjadin')
@section('content')
    ...
    <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center me-3 flex-wrap">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Master Jenis Perjadin</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-fluid">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-table-filter="search"
                                    ...
                                    placeholder="Search Jenis Perjadin" />
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--begin::Card title-->
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-table-toolbar="base">
                                <!--begin::Add Jenis Perjadin-->
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#modal_add">Tambah Jenis Perjadin</button>
                                <!--end::Add Jenis Perjadin-->
                            </div>
                            <!--end::Toolbar-->
                            <!--begin::Group actions-->
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                @foreach ($perjadins as $perjadin)
                                    <tr>
                                        ...
                                        <td>{{ $perjadin->nama }}</td>
                                        <td>{{ $perjadin->keterangan }}</td>
                                        <td>{{ $perjadin->created_at }}</td>
                                        <td class="text-end">
                                            <a href="#"
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="javascript:void(0)" data-toggle="tooltip"
                                                        data-id="{{ $perjadin->id }}" data-csrf="{{ csrf_token() }}"
                                                        data-original-title="Edit"
                                                        class="menu-link edit-perjadin px-3">Ubah</a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a href="#" class="menu-link delete-perjadin px-3"
                                                        data-id="{{ $perjadin->id }}" data-nama="{{ $perjadin->nama }}"
                ...
                <!--end::Card-->
                <!--begin::Modals-->
                <!--begin::Modal - Jenis Perjadin - Add-->
                <div class="modal fade" tabindex="-1" id="modal_add">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h3 class="modal-title">Tambah Jenis Perjadin</h3>
                            ...
                            <form id="add_form" method="post" action="{{ url('/master/jenis-perjadin') }}"
                ...
                <!--end::Modal - Jenis Perjadin - Add-->

                <!--begin::Modal - Jenis Perjadin - Edit-->
                <div class="modal fade" tabindex="-1" id="modal_edit">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h3 class="modal-title">Ubah Jenis Perjadin</h3>
...
@section('script')
    <script type="text/javascript">
        $('body').on('click', '.edit-perjadin', function() {
            var id = $(this).data('id');

            $.get("{{ url('master/jenis-perjadin') }}" + '/' + id + '/edit', function(data) {
        ...
        $(document).on('click', '.delete-perjadin', function(e) {
            e.preventDefault();
