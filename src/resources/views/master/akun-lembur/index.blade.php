                            ...
                            <form id="add_form" method="post" action="{{ url('/master/akun-lembur') }}"
                                ...
                                <div class="modal-body">
                                    <div class="fv-row mb-10">
                                        ...
                                        <input type="text" class="form-control form-control-solid" name="kode"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-10">
                                    <label for="kode" class="required form-label">Kode</label>
                                    <input type="text" class="form-control form-control-solid" id="kode"
...
@section('script')
    <script type="text/javascript">
        ...
        $(document).on('click', '.delete-lembur', function(e) {
            ...
            Swal.fire({
                text: "Apakah Anda yakin akan menghapus data kode " + kode + "?",
                icon: "warning",
                showCancelButton: !0,
                buttonsStyling: !1,
