    ...
    <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center me-3 flex-wrap">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Master Jenis Kegiatan</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-fluid">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-table-filter="search"
                                    ...
                                    placeholder="Search Jenis Kegiatan" />
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--begin::Card title-->
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-table-toolbar="base">
                                <!--begin::Add Jenis Kegiatan-->
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#modal_add">Tambah Jenis Kegiatan</button>
                                <!--end::Add Jenis Kegiatan-->
                            </div>
                            <!--end::Toolbar-->
                            <!--begin::Group actions-->
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="javascript:void(0)" data-toggle="tooltip"
                                                        data-id="{{ $kegiatan->id }}" data-csrf="{{ csrf_token() }}"
                                                        data-original-title="Edit"
                                                        class="menu-link edit-kegiatan px-3">Ubah</a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a href="#" class="menu-link delete-kegiatan px-3"
                                                        data-id="{{ $kegiatan->id }}" data-nama="{{ $kegiatan->nama }}"
                ...
                <!--end::Card-->
                <!--begin::Modals-->
                <!--begin::Modal - Jenis Kegiatan - Add-->
                <div class="modal fade" tabindex="-1" id="modal_add">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h3 class="modal-title">Tambah Jenis Kegiatan</h3>
                            ...
                            <form id="add_form" method="post" action="{{ url('/master/jenis-kegiatan') }}"
                ...
                <!--end::Modal - Jenis Kegiatan - Add-->

                <!--begin::Modal - Jenis Kegiatan - Edit-->
                <div class="modal fade" tabindex="-1" id="modal_edit">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h3 class="modal-title">Ubah Jenis Kegiatan</h3>
...
@section('script')
    <script type="text/javascript">
        $('body').on('click', '.edit-kegiatan', function() {
            ...
            $.get("{{ url('master/jenis-kegiatan') }}" + '/' + id + '/edit', function(data) {
