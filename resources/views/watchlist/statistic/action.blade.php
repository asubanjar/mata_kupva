@extends('layouts.app')
@section('title', 'Statistic Action')
@section('content')
    ...
    <div id="kt_app_toolbar" class="app-toolbar py-lg-6 py-3">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center me-3 flex-wrap">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="{{ url('/watchlist/dashboard/') }}" class="text-muted text-hover-primary">Beranda</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
            ...
            <div class="d-flex align-items-center gap-lg-3 gap-2">
                ...
                <a href="{{ url('/watchlist/dashboard/') }}" class="btn btn-sm fw-bold btn-primary">Kembali</a>
                <!--end::Primary button-->
            </div>
            <!--end::Actions-->
        </div>
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="fs-4 fw-bold" data-kt-countup="true"
                                                data-kt-countup-value="{{ $actions->count() }}">0</div>
                                        </div>
                                        <!--end::Number-->
                                        <!--begin::Label-->
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="fs-4 fw-bold" data-kt-countup="true"
                                                data-kt-countup-value="{{ $action_pendings->count() }}">0</div>
                                        </div>
                                        <!--end::Number-->
                                        <!--begin::Label-->
                        ...
                        <div class="d-flex justify-content-end" data-table-toolbar="base">
                            ...
                            <div class="w-150px me-3">
                                ...
                                <select class="form-select form-select-solid" data-control="select2"
                                    ...
                                    @foreach ($statistic_actions as $statistic_action)
                                    <option value="{{ $statistic_action->description }}">
                                        {{ $statistic_action->name }}
                                    </option>
                                    @endforeach
                                </select>
                                <!--end::Select2-->
                    ...
                    <table class="table-row-dashed fs-6 gy-5 table align-middle" id="kt_table">
                        ...
                        <tbody class="fw-semibold text-gray-600">
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ $statistic_action->description }}
                                </td>
                                <td>
                                    <div class="badge badge-light-primary">
                                        {{ $statistic_action->total_action }}
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="badge badge-light-danger">
                                        {{ $statistic_action->total_action_pending }}
                                    </div>
                                </td>
                                <td>
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="#" class="menu-link px-3" data-id="" data-csrf=""
                                                data-table-filter="delete_row">Lihat</a>
                                        </div>
                                        <!--end::Menu item-->
                                    </div>
                                    <!--end::Menu-->
