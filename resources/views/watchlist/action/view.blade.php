        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center me-3 flex-wrap">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">
                        <a href="{{ url('/watchlist/subject/' . $action->subjectDetail->subject_id) }}"
                    ...
                    <li class="breadcrumb-item text-muted"><a
                            href="{{ url('/watchlist/subject-detail/' . $action->subject_detail_id) }}"
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="d-flex justify-content-between align-items-start mb-2 flex-wrap">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <!--begin::Parent-->
                                    <a href="{{ url('/watchlist/subject-detail/' . $action->subject_detail_id) }}"
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="fs-4 fw-bold" data-kt-countup="true"
                                                data-kt-countup-value="{{ $action->checks->count() }}">0</div>
                                        </div>
                                        <!--end::Number-->
                                        <!--begin::Label-->
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="fs-4 fw-bold" data-kt-countup="true"
                                                data-kt-countup-value="{{ $checks_over_target->count() }}">0</div>
                                        </div>
                                        <!--end::Number-->
                                        <!--begin::Label-->
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="fs-4 fw-bold" data-kt-countup="true"
                                                data-kt-countup-value="{{ number_format($finish_percentage, 2, '.', ',') }}">
                                                0</div>
                                        </div>
                                        <!--end::Number-->
                                        <!--begin::Label-->
            ...
            <div class="card">
                    ...
                    <table class="table-row-dashed fs-6 gy-5 table align-middle" id="kt_table">
                        ...
                        <tbody class="fw-semibold text-gray-600">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($check->finish === null && $check->end < now()) <div
                ...
                <td class="text-end">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                        ...
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                            <a href="{{ url('/watchlist/check/' . $check->id . '/unfinish') }}"
                        ...
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                            <a href="{{ url('/watchlist/check/' . $check->id . '/finish') }}"
                        ...
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                            <a href="#" class="menu-link px-3" data-id="{{ $check->id }}" data-csrf="{{ csrf_token() }}"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <textarea rows="10" class="form-control form-control-solid"
                                    name="comment">{{ $action->comment ? $action->comment : '-' }}</textarea>
                            </div>
                            <div class="fv-row mb-10">
        ...
        <div class="modal fade" tabindex="-1" id="modal_add">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form id="add_form" method="post" action="{{ route('action-store.check', $action->id) }}"
