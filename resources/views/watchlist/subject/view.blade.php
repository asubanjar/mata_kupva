    ...
    <div id="kt_app_toolbar" class="app-toolbar py-lg-6 py-3">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            ...
            <div class="d-flex align-items-center gap-lg-3 gap-2">
                ...
                <a href="{{ url('/watchlist/subject/') }}" class="btn btn-sm fw-bold btn-primary">Kembali</a>
                <!--end::Primary button-->
            </div>
            <!--end::Actions-->
        </div>
            ...
            <div class="card">
                    ...
                    <table class="table-row-dashed fs-6 gy-5 table align-middle" id="kt_table">
                        ...
                        <tbody class="fw-semibold text-gray-600">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($subject_detail->finish === null && $subject_detail->end < now()) <div
                ...
                <td class="text-end">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                        ...
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                            <a href="{{ url('/watchlist/subject-detail/' . $subject_detail->id) }}"
                                data-toggle="tooltip" data-original-title="Lihat" class="menu-link px-3">Lihat</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                            <a href="#" class="menu-link px-3" data-id="{{ $subject->id }}"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <select class="form-select form-select-solid" aria-label="Select example"
                                    ...
                                    <option @selected($subject_type->id == $subject->subject_type_id)
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <textarea rows="10" class="form-control form-control-solid"
                                    name="comment">{{ $subject->comment }}</textarea>
                            </div>
                            <div class="fv-row mb-10">
                                <label for="exampleFormControlInput1" class="form-label">Tanggal Mulai</label>
                                <div class="fv-row input-group mb-10" id="subject_start" data-td-target-input="nearest"
                                    data-td-target-toggle="nearest">
                                    <input id="subject_start" type="text" class="form-control"
                                        data-td-target="#subject_start" name="opened" value="{{ $subject->opened }}" />
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <div class="fv-row input-group mb-10" id="subject_end" data-td-target-input="nearest"
                                    data-td-target-toggle="nearest">
                                    <input id="subject_end" type="text" class="form-control"
                                        data-td-target="#subject_end" name="closed" value="{{ $subject->closed }}" />
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <div class="fv-row input-group mb-10" id="kt_td_picker_date_only_start"
                                    ...
                                    <input id="kt_td_picker_date_only_start" type="text" class="form-control"
                                        data-td-target="#kt_td_picker_date_only_start" name="start" value="" />
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <div class="fv-row input-group mb-10" id="kt_td_picker_date_only_end"
                                    ...
                                    <input id="kt_td_picker_date_only_end" type="text" class="form-control"
                                        data-td-target="#kt_td_picker_date_only_end" name="end" value="" />
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form id="add_form_lampiran" method="post"
                        ...
                        @csrf
                        <div class="modal-body">
                            <input type="hidden" id="uniqid" name="uniqid" value="{{ $uniqid = uniqid() }}">
                            <div class="fv-row mb-10">
                                <!--begin::Dropzone-->
...
$(function() {
    ...
    $('#attachments').on('click', '.delete-button', function() {
        ...
        $.ajax({
            url: '/watchlist/subject-attachment/' + id,
            type: 'DELETE',
    ...
    $('#attachments').on('click', '.show-button', function() {
        ...
        var url = '/watchlist/subject-attachment/' + id + '/download';
