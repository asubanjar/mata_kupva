<?php $__env->startSection('title', 'Action List'); ?>
    ...
    <div id="kt_app_toolbar" class="app-toolbar py-lg-6 py-3">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center me-3 flex-wrap">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="<?php echo e(url('/watchlist/dashboard/')); ?>" class="text-muted text-hover-primary">Beranda</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted"><a href="#">Rencana Aksi</a></li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
            ...
            <div class="d-flex align-items-center gap-lg-3 gap-2">
                ...
                <a href="<?php echo e(url('/watchlist/dashboard/')); ?>" class="btn btn-sm fw-bold btn-primary">Kembali</a>
                <!--end::Primary button-->
            </div>
            <!--end::Actions-->
        </div>
        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="fs-4 fw-bold" data-kt-countup="true"
                                                data-kt-countup-value="<?php echo e($actions_over_target->count()); ?>">0</div>
                                        </div>
                                        <!--end::Number-->
                                        <!--begin::Label-->
            ...
            <div class="card">
                        ...
                        <div class="d-flex justify-content-end" data-table-toolbar="base">
                            ...
                            <div class="w-150px me-3">
                                ...
                                <select class="form-select form-select-solid" data-control="select2"
                                    ...
                                    <option value="<?php echo e($jabatan->description); ?>">
                    ...
                    <table class="table-row-dashed fs-6 gy-5 table align-middle" id="kt_table">
                        ...
                        <tbody class="fw-semibold text-gray-600">
                            ...
                            <tr>
                                ...
                                <td><?php echo e($action->success_indicator); ?></td>
                                <td>
                                    <?php if($action->finish === null && $action->end < now()): ?> <div
                                        class="badge badge-light-danger">
                                        <?php echo e($action->start->format('d/m/Y')); ?> s/d
                                        <?php echo e($action->end->format('d/m/Y')); ?>

                </div>
                <?php elseif($action->finish != null || $action->end >= now()): ?>
                ...
                <td>
                    ...
                    <div class="badge badge-light-success">
                        <?php echo e($action->finish->format('d/m/Y')); ?></div>
                    <?php else: ?>
                    <div class="badge badge-light-danger">Dalam Proses</div>
                    <?php endif; ?>
                </td>
                <td><?php echo e($action->jabatan->description); ?></td>
                ...
                <td><?php echo e($action->checks->count()); ?></td>
                <td><?php echo e($action->subjectDetail->name); ?></td>
                <td><?php echo e($action->subjectDetail->subject->name); ?></td>
                <td class="text-end">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                        ...
                        <div class="menu-item px-3">
                            <a href="<?php echo e(url('/watchlist/subject/action/' . $action->id . '/check')); ?>"
                                data-toggle="tooltip" data-original-title="Lihat" class="menu-link px-3">Lihat</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                            <a href="#" class="menu-link px-3" data-id="<?php echo e($action->id); ?>"
                                data-csrf="<?php echo e(csrf_token()); ?>" data-table-filter="delete_row">Hapus</a>
                        </div>
                        <!--end::Menu item-->
                    </div>
                    <!--end::Menu-->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\hackathon-bi\resources\views/watchlist/action/index.blade.php ENDPATH**/ ?>