                                                ...
                                                <div class="row g-5 g-lg-9">
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <div class="card card-shadow">
                                                            ...
                                                            <div class="card-body p-0">
                                                                <!--begin::Items-->
                                                                <a href="<?php echo e(url('/kearsipan/registrasi/naskah-dinas/create')); ?>"
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <div class="card card-shadow">
                                                            ...
                                                            <div class="card-body p-0">
                                                                <!--begin::Items-->
                                                                <a href="<?php echo e(url('/kearsipan/kotak-masuk/disposisi')); ?>"
                                                                    class="btn btn-active-color-primary w-100 px-7 py-6 text-start">
                                                                    <!--begin::Icon-->
                                                                    <i
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <div class="card card-shadow">
                                                            ...
                                                            <div class="card-body p-0">
                                                                <!--begin::Items-->
                                                                <a href="<?php echo e(url('/kearsipan/kotak-keluar/naskah-dinas')); ?>"
                                                                    class="btn btn-active-color-primary w-100 px-7 py-6 text-start">
                                                                    <!--begin::Icon-->
                                                                    <i
                                        ...
                                        <div class="card-body pt-5">
                                            ...
                                            <div class="timeline-label">
                                                ...
                                                <div class="timeline-item">
                                                    ...
                                                    <!--begin::Content-->
                                                    <div class="timeline-content d-flex">
                                                        <span class="fw-bold text-gray-800 ps-3">Pelimpahan Wewenang
                                                            Pendatanganan Naskah Dinas di Lingkungan Pusat Pelaporan dan
                                                            Analisis Transaksi Keuangan
                                                            Klasifikasi Arsip di Lingkungan Pusat Pelaporan dan Analisis
