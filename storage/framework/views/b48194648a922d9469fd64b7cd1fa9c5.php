                ...
                <div class="page-title d-flex flex-column justify-content-center me-3 flex-wrap">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="<?php echo e(url('/')); ?>" class="text-muted text-hover-primary">Utama</a>
                        </li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted"><a href="#">Daftar Pengguna</a></li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                                ...
                                <div class="d-flex justify-content-start flex-wrap">
                                    ...
                                    <div class="d-flex flex-wrap">
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="fs-4 fw-bold" data-kt-countup="true"
                                                    data-kt-countup-value="<?php echo e($users->count()); ?>">0</div>
                                            </div>
                                            <!--end::Number-->
                                            <!--begin::Label-->
                                            <div class="fw-semibold fs-6 text-gray-400">Jumlah Pengguna</div>
                                            <!--end::Label-->
                                        </div>
                                        <!--end::Stat-->
                                        <!--begin::Stat-->
                                        <div
                                            ...
                                            <!--end::Number-->
                                            <!--begin::Label-->
                                            <div class="fw-semibold fs-6 text-gray-400">Jumlah Pengguna Tidak Aktif
                                            </div>
                                            <!--end::Label-->
                                        </div>
                                        <!--end::Stat-->
                            ...
                            <div class="d-flex justify-content-end" data-table-toolbar="base">
                                ...
                                <div class="w-150px me-3">
                                    ...
                                    <select class="form-select form-select-solid" data-control="select2"
                                        data-hide-search="true" data-placeholder="Status" data-kt-unit-filter="unit">
                                        <option></option>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\hackathon-bi\resources\views/user/index.blade.php ENDPATH**/ ?>