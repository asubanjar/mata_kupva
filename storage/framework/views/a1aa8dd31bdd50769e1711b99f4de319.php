        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center me-3 flex-wrap">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">
                        <a href="<?php echo e(url('/watchlist/subject')); ?>" class="text-muted text-hover-primary">Daftar</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
                    ...
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">
                        <a href="<?php echo e(url('/watchlist/subject/' . $action->subjectDetail->subject_id)); ?>"
                    ...
                    <li class="breadcrumb-item text-muted"><a
                            href="<?php echo e(url('/watchlist/subject-detail/' . $action->subject_detail_id)); ?>"
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="d-flex justify-content-between align-items-start mb-2 flex-wrap">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <!--begin::Parent-->
                                    <a href="<?php echo e(url('/watchlist/subject-detail/' . $action->subject_detail_id)); ?>"
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="fs-4 fw-bold" data-kt-countup="true"
                                                data-kt-countup-value="<?php echo e(number_format($finish_percentage, 2, '.', ',')); ?>">
                                                0</div>
                                        </div>
                                        <!--end::Number-->
                                        <!--begin::Label-->
            ...
            <div class="card">
                    ...
                    <table class="table-row-dashed fs-6 gy-5 table align-middle" id="kt_table">
                        ...
                        <tbody class="fw-semibold text-gray-600">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if($check->finish === null && $check->end < now()): ?> <div
                ...
                <td class="text-end">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                        ...
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                            <a href="<?php echo e(url('/watchlist/check/' . $check->id . '/unfinish')); ?>"
                        ...
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                            <a href="<?php echo e(url('/watchlist/check/' . $check->id . '/finish')); ?>"
                        ...
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                            <a href="#" class="menu-link px-3" data-id="<?php echo e($check->id); ?>" data-csrf="<?php echo e(csrf_token()); ?>"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <textarea rows="10" class="form-control form-control-solid"
                                    name="comment"><?php echo e($action->comment ? $action->comment : '-'); ?></textarea>
                            </div>
                            <div class="fv-row mb-10">
        ...
        <div class="modal fade" tabindex="-1" id="modal_add">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form id="add_form" method="post" action="<?php echo e(route('action-store.check', $action->id)); ?>"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <div class="fv-row input-group mb-10" id="kt_td_picker_date_only_start_check"
                                    data-td-target-input="nearest" data-td-target-toggle="nearest">
                                    <input id="kt_td_picker_date_only_start_check" type="text" class="form-control"
                                        data-td-target="#kt_td_picker_date_only_start_check" name="start" value="" />
                                    <span class="input-group-text" data-td-target="#kt_td_picker_date_only_start_check"
                                        data-td-toggle="datetimepicker">
                                        <i class="ki-duotone ki-calendar fs-2"><span class="path1"></span><span
                                                class="path2"></span></i>
                                    </span>
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <div class="fv-row input-group mb-10" id="kt_td_picker_date_only_end_check"
                                    data-td-target-input="nearest" data-td-target-toggle="nearest">
                                    <input id="kt_td_picker_date_only_end_check" type="text" class="form-control"
                                        data-td-target="#kt_td_picker_date_only_end_check" name="end" value="" />
                                    <span class="input-group-text" data-td-target="#kt_td_picker_date_only_end_check"
                                        data-td-toggle="datetimepicker">
                                        <i class="ki-duotone ki-calendar fs-2"><span class="path1"></span><span
                                                class="path2"></span></i>
                                    </span>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\hackathon-bi\resources\views/watchlist/action/view.blade.php ENDPATH**/ ?>