...
<div id="kt_app_header" class="app-header" data-kt-sticky="true" data-kt-sticky-activate="{default: true, lg: true}"
    ...
    data-kt-sticky-animation="false" style="background-color: #F9B314;">
        ...
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
            ...
            <div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true"
                ...
                <div
                    ...
                    <!--begin:Menu item-->
                    <div data-kt-menu-placement="bottom-start" class="menu-item me-0 me-lg-2">
                        <a href="<?php echo e(route('watchlists.index')); ?>" class="menu-link">
                ...
                <div
                    ...
                    <!--begin:Menu item-->
                    <div data-kt-menu-placement="bottom-start" class="menu-item me-0 me-lg-2">
                        <a href="<?php echo e(route('about.index')); ?>" class="menu-link">
        ...
        <div class="app-navbar flex-shrink-0">
            ...
            <div class="app-navbar-item ms-md-4 ms-1" id="kt_header_user_menu_toggle">
                ...
                <div class="symbol symbol-35px cursor-pointer" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                    ...
                    <img src="<?php echo e(asset('assets/media/avatars/300-1.jpg')); ?>" class="rounded-3" alt="user" />
                </div>
                    ...
                    <div class="menu-item px-3">
                        <div class="menu-content d-flex align-items-center px-3">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <a href="#"
                                    class="fw-semibold text-muted text-hover-primary fs-7"><?php echo e(Auth::user()->name); ?></a>
                            </div>
                            <!--end::Username-->
                        </div>
                    </div>
...
</html><?php /**PATH C:\laragon\www\hackathon-bi\resources\views/layouts/header.blade.php ENDPATH**/ ?>