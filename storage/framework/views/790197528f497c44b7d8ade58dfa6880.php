                                    ...
                                    <div class="d-flex flex-wrap">
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="fs-4 fw-bold" data-kt-countup="true"
                                                    data-kt-countup-value="<?php echo e($subjects->count()); ?>">0</div>
                                            </div>
                                            <!--end::Number-->
                                            <!--begin::Label-->
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="fs-4 fw-bold" data-kt-countup="true"
                                                    data-kt-countup-value="<?php echo e($subject_openeds->count()); ?>">0</div>
                                            </div>
                                            <!--end::Number-->
                                            <!--begin::Label-->
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="fs-4 fw-bold" data-kt-countup="true"
                                                    data-kt-countup-value="<?php echo e($progress_percentage); ?>">0</div>
                                            </div>
                                            <!--end::Number-->
                                            <!--begin::Label-->
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($subject->subjectType->name); ?></td>
                                        <td><?php echo e($subject->comment); ?></td>
                                        <td><?php echo e($subject->opened->format('d/m/Y')); ?></td>
                                        <td><?php echo e($subject->closed ? $subject->closed->format('d/m/Y') : '-'); ?></td>
                                        <td>
                                            <?php if($subject->active === true): ?>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="<?php echo e(url('/monitoring-pimpinan/monitoring/subject/' . $subject->id)); ?>"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="#" class="menu-link px-3"
                                                        data-id="<?php echo e($subject->id); ?>" data-csrf="<?php echo e(csrf_token()); ?>"
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <form id="add_form" method="post"
                                action="<?php echo e(url('/monitoring-pimpinan/monitoring/subject')); ?>" class="needs-validation"
                                novalidate="">
                                <?php echo csrf_field(); ?>
                                <div class="modal-body">
                                    ...
                                    <div class="fv-row mb-10">
                                        ...
                                        <select class="form-select form-select-solid" aria-label="Select example"
                                            ...
                                            <?php $__currentLoopData = $subject_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($subject_type->id); ?>"><?php echo e($subject_type->name); ?>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        var myDropzone = new Dropzone(id, { // Make the whole body a dropzone
            addRemoveLinks: true,
            url: "/upload/<?php echo e($uniqid); ?>/subject_attachments", // Set the url for your upload script location
            parallelUploads: 20,
        ...
        myDropzone.on("removedfile", function(file) {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: '/upload-delete/<?php echo e($uniqid); ?>/subject_attachments',
                data: {
                    filename: name
                },
                dataType: 'html'
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\hackathon-bi\resources\views/monitoring-pimpinan/monitoring/subject/index.blade.php ENDPATH**/ ?>