<?php $__env->startSection('title', 'Registrasi Naskah Dinas'); ?>
    ...
    <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center me-3 flex-wrap">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            <a href="<?php echo e(url('/kearsipan')); ?>" class="text-muted text-hover-primary">Kearsiapan</a>
                        </li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            <a href="<?php echo e(url('/kearsipan/registrasi/naskah-dinas')); ?>"
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-fluid">
                <form id="add_form" method="post" action="<?php echo e(route('naskah-dinas.store')); ?>" class="needs-validation"
                    novalidate="">
                    <?php echo csrf_field(); ?>
                    <!--begin::Layout-->
                                        ...
                                        <div class="row gx-10">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="hidden" id="uniqid" name="uniqid"
                                                    value="<?php echo e($uniqid = uniqid()); ?>">
                                                <!--begin::Input group-->
                                                <div class="mb-5">
                                                ...
                                                <div class="fv-row mb-5">
                                                    ...
                                                    <select name="jenis_naskah_code" aria-label="Jenis Naskah"
                                                        ...
                                                        <?php $__currentLoopData = $jenis_naskahs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jenis_naskah): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($jenis_naskah->code); ?>">
                                                                <?php echo e($jenis_naskah->name); ?>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="row mb-5">
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <select name="satuan_unit_code" aria-label="Jenis Lampiran"
                                                            ...
                                                            <?php $__currentLoopData = $satuan_units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $satuan_unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($satuan_unit->code); ?>">
                                                                    <?php echo e($satuan_unit->name); ?>
                                                    ...
                                                    <select name="classification_id" aria-label="Kode Klasifikasi"
                                                        ...
                                                        <?php $__currentLoopData = $classifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($classification->id); ?>">
                                                                <?php echo e($classification->code); ?> - <?php echo e($classification->name); ?>
                                                ...
                                                <div class="fv-row mb-5">
                                                    ...
                                                    <select name="urgensi_code" aria-label="Tingkat Urgensi"
                                                        ...
                                                        <?php $__currentLoopData = $urgensis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $urgensi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($urgensi->code); ?>">
                                                                <?php echo e($urgensi->name); ?>
                                                ...
                                                <div class="fv-row mb-5">
                                                    ...
                                                    <select name="sifat_code" aria-label="Sifat Naskah"
                                                        ...
                                                        <?php $__currentLoopData = $sifats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sifat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($sifat->code); ?>">
                                                                <?php echo e($sifat->name); ?>
                                        ...
                                        <div class="fv-row mb-5">
                                            ...
                                            <select name="jabatan_to_code[]" class="form-select "
                                                ...
                                                <?php $__currentLoopData = $receivers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $receiver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($receiver->jabatan_code); ?>">
                                                        <?php echo e($receiver->position); ?>
                                    ...
                                    <div>
                                        ...
                                        <div class="fv-row mb-5">
                                            ...
                                            <select name="signer_id" aria-label="Penandatangan Naskah"
                                                ...
                                                <?php $__currentLoopData = $signers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $signer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($signer->id); ?>">
                                                        <?php echo e($signer->name); ?> - <?php echo e($signer->position); ?>
                                        ...
                                        <div id="jenjang" class="fv-row mb-5">
                                            ...
                                            <div class="row">
                                                ...
                                                <div id="jenjang_atasan_langsung" class="col-lg-9 mb-5"
                                                    ...
                                                    <input type="text" disabled
                                                        class="form-control  disabled"
                                                        placeholder="<?php echo e(Auth::user()->atasan->name); ?>">
                                                </div>
...
<?php $__env->startSection('script'); ?>
    <script src="<?php echo e(asset('assets/js/pages/registrasi-naskah/validate.js')); ?>"></script>
    ...
    <script>
        var myDropzone = new Dropzone("#naskah", {
            url: "/kearsipan/upload-naskah/<?php echo e($uniqid); ?>/outbox", // Set the url for your upload script location
            paramName: "file",
            maxFiles: 1,
            maxFilesize: 10,
            headers: {
                ...
                this.on("removedfile", function(file) {
                    if (confirm("Apakah anda yakin akan menghapus naskah ini?")) {
                        $.ajax({
                            ...
                            type: 'POST',
                            url: '/upload-delete/<?php echo e($uniqid); ?>/inbox_attachments',
                            data: {
                                filename: file.name
                            },
    ...
    <script>
        var myDropzone = new Dropzone("#lampiran", {
            url: "/kearsipan/upload-naskah/<?php echo e($uniqid); ?>/lampiran", // Set the url for your upload script location
            paramName: "file",
            maxFiles: 3,
            maxFilesize: 10,
            headers: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\hackathon-bi\resources\views/kearsipan/registrasi/naskah-dinas/create.blade.php ENDPATH**/ ?>