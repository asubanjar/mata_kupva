...
@font-face {
    font-family: 'Inter';
    src: url('<?php echo e(asset('assets/fonts/inter/static/Inter-Regular.ttf')); ?>') format('truetype');
    font-weight: normal;
    font-style: normal;
}
...
<head>
    <base href="" />
    <title>MATA KUPVA - <?php echo $__env->yieldContent('title'); ?></title>
    <meta charset="utf-8" />
...
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\hackathon-bi\resources\views/layouts/app.blade.php ENDPATH**/ ?>