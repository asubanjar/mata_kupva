<?php $__env->startSection('title', 'Daftar Subjek'); ?>
            ...
            <div class="row g-5 gx-xl-10 mb-xl-10 mb-5">
                ...
                <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
                    ...
                    <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-md-50 mb-xl-10 mb-5"
                        ...
                        <div class="card-header pt-5">
                            ...
                            <div class="card-title d-flex flex-column">
                                <!--begin::Amount-->
                                <span class="fs-2hx fw-bold lh-1 ls-n2 me-2 text-white"><?php echo e($subjects->count()); ?></span>
                                <!--end::Amount-->
                                <!--begin::Subtitle-->
                        ...
                        <div class="card-body d-flex align-items-end pt-0">
                            ...
                            <div class="d-flex align-items-center flex-column w-100 mt-3">
                                <div
                                    ...
                                    <span><?php echo e($subject_pendings->count()); ?> Dalam proses</span>
                                    <span><?php echo e($subject_finish_percentage); ?>%</span>
                                </div>
                                <div class="h-8px w-100 mx-3 rounded bg-white bg-opacity-50">
                                    <div class="h-8px rounded bg-white" role="progressbar"
                                        style="width: <?php echo e($subject_finish_percentage); ?>%;" aria-valuenow="50"
                    ...
                    <div class="card card-flush h-lg-50">
                        ...
                        <div class="card-header pt-5">
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px"
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="<?php echo e(url('/monitoring-pimpinan/statistic/action')); ?>"
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="<?php echo e(url('/monitoring-pimpinan/monitoring/action')); ?>"
                        ...
                        <div class="card-body pt-5">
                            <?php $__currentLoopData = $statistic_jabatan_finishes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $statistic_jabatan_finish): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <!--begin::Item-->
                            <div class="d-flex flex-stack">
                                <!--begin::Section-->
                                <a href="#"
                                    class="text-primary fw-semibold fs-6 me-2"><?php echo e($statistic_jabatan_finish->name); ?></a>
                                <!--end::Section-->
                                <!--begin::Action-->
                                <button type="button"
                                    class="btn btn-icon btn-sm btn-color-gray-400 btn-active-color-primary justify-content-end h-auto w-auto">
                                    <?php echo e($statistic_jabatan_finish->total_action_finish); ?> /
                                    <?php echo e($statistic_jabatan_finish->total_action); ?>
                ...
                <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
                        ...
                        <div class="card-header pt-5">
                            ...
                            <div class="card-title d-flex flex-column">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <span
                                        class="fs-2hx fw-bold text-dark lh-1 ls-n2 me-2"><?php echo e($subject_details->count()); ?></span>
                                    <!--end::Subject Detail-->
                                    <!--begin::Badge-->
                                    <span class="badge badge-light-success fs-base">
                                        <i class="ki-duotone ki-arrow-up fs-5 text-success ms-n1">
                                            <span class="path1"></span>
                                            <span class="path2"></span>
                                        </i><?php echo e(number_format($subject_detail_finish_percentage, 2, '.', ',')); ?>%
                                        Selesai</span>
                                    <!--end::Badge-->
                                </div>
                                <!--end::Info-->
                            ...
                            <div class="d-flex flex-column content-justify-center flex-row-fluid">
                                ...
                                <div class="d-flex fw-semibold align-items-center">
                                    ...
                                    <div class="fw-bolder text-xxl-end text-gray-700">
                                        <?php echo e($subject_detail_finishes->count()); ?></div>
                                    <!--end::Stats-->
                                </div>
                                <!--end::Label-->
                                <!--begin::Label-->
                                <div class="d-flex fw-semibold align-items-center my-3">
                                    ...
                                    <!--begin::Stats-->
                                    <div class="fw-bolder text-xxl-end text-gray-700">
                                        <?php echo e($subject_detail_pendings->count()); ?></div>
                                    <!--end::Stats-->
                                </div>
                                <!--end::Label-->
                            </div>
                    ...
                    <div class="card card-flush h-lg-50">
                        ...
                        <!--begin::Body-->
                        <div class="card-body pt-5">
                            <?php $__currentLoopData = $statistic_jabatan_pendings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $statistic_jabatan_pending): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <!--begin::Item-->
                            <div class="d-flex flex-stack">
                                <!--begin::Section-->
                                <a href="#"
                                    class="text-danger fw-semibold fs-6 me-2"><?php echo e($statistic_jabatan_pending->name); ?></a>
                                <!--end::Section-->
                                <!--begin::Action-->
                                <button type="button"
                                    class="btn btn-icon btn-sm btn-color-gray-400 btn-active-color-primary justify-content-end h-auto w-auto">
                                    <?php echo e($statistic_jabatan_pending->total_action_pending); ?> /
                                    <?php echo e($statistic_jabatan_pending->total_action); ?>
                        ...
                        <div class="card-header mb-7 pt-7">
                            ...
                            <h3 class="card-title align-items-start flex-column">
                                ...
                                <span class="fw-semibold fs-6 mt-1 text-gray-400">Total
                                    <?php echo e($statistic_jabatans->count()); ?> Jabatan</span>
                            </h3>
                            <!--end::Title-->
                            <!--begin::Toolbar-->
                            <div class="card-toolbar">
...
<script src="<?php echo e(asset('assets/js/custom/utilities/modals/top-up-wallet.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/custom/utilities/modals/create-account.js')); ?>"></script>
...
var KTChartsWidget31 = (function() {
    ...
    var initChart1 = function() {
        ...
        var init = function() {
            ...
            var data = [
                <?php $__currentLoopData = $statistic_jabatans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $statistic_jabatan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> {
                    name: "<?php echo e($statistic_jabatan->name); ?>",
                    value1: {
                        {
                            $statistic_jabatan - > total_action_finish
                        }
                    },
                    value2: {
                        {
                            $statistic_jabatan - > total_action - $statistic_jabatan - >
                                total_action_finish
                        }
                    },
                },
...
am5.ready(function() {
    ...
    var data = [
        <?php $__currentLoopData = $statistic_jabatans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $statistic_jabatan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> {
            jabatan: "<?php echo e($statistic_jabatan->name); ?>",
            action_selesai: {
                {
                    $statistic_jabatan - > total_action_finish
                }
            ...
            action_proses: {
                {
                    $statistic_jabatan - > total_action - $statistic_jabatan - > total_action_finish
                }
            },
        },
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\hackathon-bi\resources\views/monitoring-pimpinan/index.blade.php ENDPATH**/ ?>