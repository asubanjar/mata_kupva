                            ...
                            <tbody class="fw-semibold text-gray-600">
                                <?php $__currentLoopData = $actions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($action->finish === null && $action->end < now()): ?>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="<?php echo e(url('/monitoring-pimpinan/monitoring/subject/action/' . $action->id . '/check')); ?>"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="#" class="menu-link px-3"
                                                        data-id="<?php echo e($action->id); ?>" data-csrf="<?php echo e(csrf_token()); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\hackathon-bi\resources\views/monitoring-pimpinan/monitoring/action/index.blade.php ENDPATH**/ ?>